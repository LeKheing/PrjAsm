            ...
            <div class="row">
                ...
                <div class="col-sm-6 mx-auto">
                    <form action="admin-edit-product" method="post">
                        <input name="id" value="${product.id}" hidden="hidden"/>
                        <input name="product_img" value="${product.image}" hidden="hidden"/>
                        <input name="cate" value="${product.c_id}" hidden="hidden"/>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="weight" class="form-control" min="0" value="${product.weight}" step="0.1" required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="quality" value="${product.quality}" class="form-control">
                        </div>
                        <div class="mb-3">
