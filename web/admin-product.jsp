                ...
                <nav class="navbar navbar-light navbar-expand-xl bg-white">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="admin-order" class="nav-item nav-link">View order</a>
                        </div>
                        ...
                        <tbody>
                            <c:forEach items="${products}" var="product">
                                <tr style="font-size: 20px;">
                                    <td></td>
                                    <td>${product.name}</td>
                                    <td>$<fmt:formatNumber value="${product.price}" pattern="#0.00"/>/kg</td>
                                    <td>${product.description}</td>
                                    <td>
                                        <div>
                                            <form action="admin-edit-product">
                                                <input type="hidden" name="id" value="${product.id}"/>
                                                <button type="submit" class="btn btn-warning link-success">Edit</button>
                                            </form>
                                        </div>
                                        <br/>
                                        <div>
                                            <form action="admin-delete-product" method="POST">
                                                <input type="hidden" name="id" value="${product.id}"/>
                                                <button type="submit" class="btn btn-danger link-light">Delete</button>
                                            </form>
                                        </div>
